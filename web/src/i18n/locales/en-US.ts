export default {
    ...
    canvas: {
        ...
        sidePanel: {
            multiSelectAssets: "Select multiple", selectFilteredAssets: "Select all results", insertSelectedAssets: "Add to canvas ({{count}})", deleteSelectedAssets: "Delete {{count}} assets?", deleteSelectedAssetsHint: "This only removes them from the asset library and does not affect content already added to the canvas.", cancelAssetSelection: "Clear selection",
