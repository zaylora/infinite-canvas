export default {
    ...
    canvas: {
        ...
        sidePanel: {
            multiSelectAssets: "多选", selectFilteredAssets: "全选当前结果", insertSelectedAssets: "加入画布（{{count}}）", deleteSelectedAssets: "删除 {{count}} 个资产？", deleteSelectedAssetsHint: "删除后只会从素材库移除，不会影响已经加入画布的内容。", cancelAssetSelection: "取消选择",
